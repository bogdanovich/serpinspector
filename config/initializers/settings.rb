...
Settings.defaults[:log_viewer_available_files]  = ["delayed_job.log", "production.log", "development.log", "test.log"]
Settings.defaults[:log_viewer_current_file]     = Rails.env + '.log'
